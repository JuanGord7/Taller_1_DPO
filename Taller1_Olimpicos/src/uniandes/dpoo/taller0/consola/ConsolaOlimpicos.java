...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("\n" + "País representado por un atleta" + "\n");
		String nombre_atleta = input("Por favor ingrese el nombre de un atleta");
		String respuesta = calculadora.buscarPaisAtleta(nombre_atleta);
		System.out.println("El atleta representa al siguiente país: "+ respuesta);
